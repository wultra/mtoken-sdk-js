...
export class TestSuite_Deserialization extends TestSuite {
    ...
    testRealData() {
        ...
        const amountAttr = operation.formData.attributes[0] as WMTOperationAttributeAmount
    ...
    testRealData2() {
        ...
        const amountAttr = operation.formData.attributes[0] as WMTOperationAttributeAmount
        this.assertEquals(WMTAttributeType.AMOUNT, amountAttr.type)
        ...
        const kva = operation.formData.attributes[1] as WMTOperationAttributeKeyValue
        this.assertEquals(WMTAttributeType.KEY_VALUE, kva.type)
        this.assertEquals("operation.account", kva.id)
        this.assertEquals("Na účet", kva.label)
        this.assertEquals("238400856/0300", kva.value)

        const na = operation.formData.attributes[3] as WMTOperationAttributeNote
        this.assertEquals(WMTAttributeType.NOTE, na.type)
        ...
        const ca = operation.formData.attributes[5] as WMTOperationAttributeAmountConversion
        this.assertEquals(WMTAttributeType.AMOUNT_CONVERSION, ca.type)
        ...
        const ia = operation.formData.attributes[6] as WMTOperationAttributeImage
        this.assertEquals(WMTAttributeType.IMAGE, ia.type)
        ...
        const ia2 = operation.formData.attributes[7] as WMTOperationAttributeImage
        this.assertEquals(WMTAttributeType.IMAGE, ia2.type)
        ...
        const ia3 = operation.formData.attributes[8] as WMTOperationAttributeImage
        this.assertEquals(WMTAttributeType.IMAGE, ia3.type)
    ...
    testAmountConversionAttributesResponseWithOnlyAmountFormattedAndCurrencyFormatted() {
        ...
        const amountAttr = response.responseObject!!![0].formData.attributes[0] as WMTOperationAttributeAmount
        ...
        const conversionAttr = response.responseObject!!![0].formData.attributes[1] as WMTOperationAttributeAmountConversion
